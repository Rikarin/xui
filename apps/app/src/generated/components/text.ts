...
@Component({
  ...
  template: ` <p xuiText [ellipsize]="false">The quick brown fox jumps over the lazy dog.</p> `
})
...
@Component({
  ...
  template: `
    <div class="flex max-w-prose flex-col gap-2">
      ...
      <blockquote xuiBlockquote>A directive on the native element keeps the semantics in the markup.</blockquote>
