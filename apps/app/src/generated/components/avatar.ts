  ...
  symbols: [
    {
      ...
      docs: 'Overlaps a set of {@link XuiAvatar}s into a stack. With `max`, only the first\n`max` avatars show and the rest collapse into a trailing `+N` avatar.\n\n```html\n<xui-avatar-group [max]="3">\n  <xui-avatar text="A" />\n  <xui-avatar text="B" />\n  ...\n</xui-avatar-group>\n```',
      inputs: [
        {
          name: 'class',
          type: 'ClassValue',
