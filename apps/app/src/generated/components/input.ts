...
@Component({
  ...
  template: `
    ...
    <label xuiLabel class="mt-4 grid w-80 gap-2">
      Small:
    ...
    <div class="relative mt-4 grid w-80">
      <input xuiInput type="email" placeholder="Email" />
      <button xuiButton class="absolute right-1.5 bottom-1.5 h-8" size="sm" type="button">Search!</button>
    </div>
    ...
    <div class="relative mt-4 grid w-80">
      <span class="absolute top-2 left-2 font-semibold">https://</span>
      <input xuiInput class="pl-17" type="email" placeholder="Website" />
      <span class="absolute top-2 right-2 font-semibold">.io</span>
    </div>
  ...
  symbols: [
    {
      ...
      docs: 'A non-interactive adornment pinned to the leading edge of an input — an icon,\na currency symbol, a short prefix. Pointer events pass through to the input.',
      inputs: [],
      outputs: [],
      variants: [],
      methods: []
