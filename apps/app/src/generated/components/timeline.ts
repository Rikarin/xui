  ...
  symbols: [
    {
      ...
      docs: 'One entry on a {@link XuiTimeline}: a colored dot on the axis and projected\ncontent beside it, with an optional `label`.',
      inputs: [
        {
          name: 'color',
          type: 'TimelineColor',
