...
export class PreviewRatios {
  protected ratios: any = [16 / 9, 4 / 3, 1] as number[];
  protected labels: any = ['16 / 9', '4 / 3', '1 / 1'];
}
...
export const doc: ComponentDoc = {
  ...
  symbols: [
  {
    ...
    "docs": "Locks its content to a fixed width : height ratio, so media and embeds keep their shape as the column resizes. Give it a width (the default is 100%); the height follows from the ratio.",
    "inputs": [
      {
        "name": "class",
        "type": "ClassValue",
