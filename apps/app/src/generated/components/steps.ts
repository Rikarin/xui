...
export const doc: ComponentDoc = {
  ...
  symbols: [
  {
    ...
    "name": "XuiStep",
    "selector": "xui-step",
    "docs": "One step inside {@link XuiSteps}. title/description describe it; status overrides the status the parent would otherwise derive from current.",
    "inputs": [
      {
        "name": "title",
        "type": "string",
  ...
  },
  {
    ...
    "name": "XuiSteps",
    "selector": "xui-steps",
    "docs": "A step / wizard progress indicator. Wrap <xui-step> entries and bind current (two-way) to the active index; each step's status is derived (finish before, process at, wait after) unless the step overrides it. With clickable, clicking a step moves current.",
    "inputs": [
      {
        "name": "class",
        "type": "ClassValue",
