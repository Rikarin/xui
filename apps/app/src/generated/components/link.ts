...
@Component({
  ...
  template: ` <a xuiLink href="https://xuijs.org" color="link" underline="always">Documentation</a> `
})
...
@Component({
  ...
  template: `
    <p class="text-foreground-muted max-w-prose">
      ...
      <a xuiLink color="inherit" underline="hover" href="https://xuijs.org">token layer</a>, so switching theme
      re-colours the whole page without a rebuild.
    </p>
  `
})
  ...
  symbols: [
    {
      ...
      variants: [
        ...
        {
          name: 'color',
          options: ['inherit', 'link', 'primary', 'secondary', 'success', 'error', 'warning', 'info'],
          default: 'link'
        }
      ],
      methods: []
