  ...
  symbols: [
  {
    ...
    "inputs": [
      ...
      },
      {
        ...
        "required": false,
        "model": true,
        "docs": "The indeterminate state of the checkbox. For example, a \"select all/deselect all\" checkbox may be in the indeterminate state when some but not all of its sub-controls are checked."
      },
      {
        "name": "name",
        "type": "string | null",
