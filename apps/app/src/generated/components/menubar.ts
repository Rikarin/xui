...
export const doc: ComponentDoc = {
  ...
  symbols: [
  {
    ...
    "selector": "[xuiMenubar]",
    "exportAs": "xuiMenubar",
    "docs": "A horizontal application menu bar (File / Edit / View …). Built on @angular/cdk/menu's CdkMenuBar, so it gets roving tab focus, arrow-key movement between menus, open-adjacent-on-arrow, and hover-to-switch once a menu is open. Fill the dropdowns with @xui/menu (<xui-menu> / [xuiMenuItem]).",
    "inputs": [
      {
        "name": "class",
        "type": "ClassValue",
  ...
  },
  {
    ...
    "docs": "A top-level menu bar item that opens a menu. It is both a CdkMenuItem (so it takes part in the bar's roving focus) and a CdkMenuTrigger (so it opens its menu). Point xuiMenubarTriggerFor at an <ng-template> holding an <xui-menu>.",
    "inputs": [
      {
        "name": "class",
        "type": "ClassValue",
