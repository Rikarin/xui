...
export class PreviewCheckbox {
  protected a: any = true;
  protected b: any = false;
}
...
export const doc: ComponentDoc = {
  ...
  symbols: [
  {
    ...
    "docs": "A selectable card wrapping a label and a control indicator. The card itself is the interactive control — click or press Space/Enter to toggle — so there is no nested interactive element. type chooses the checkbox/radio/switch look and the matching ARIA role.",
    "inputs": [
      {
        "name": "class",
        "type": "ClassValue",
