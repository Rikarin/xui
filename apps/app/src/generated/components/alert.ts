...
@Component({
  ...
  template: `
    ...
    @if (result()) {
      <p class="text-foreground-muted mt-3 text-sm">You chose: {{ result() }}</p>
    }
    <xui-alert
      [(isOpen)]="open"
      intent="error"
...
@Component({
  ...
  template: `
    ...
    <xui-alert [(isOpen)]="open" intent="success" confirmText="Got it"> Your changes have been published. </xui-alert>
  `
})
