...
@Component({
  ...
  imports: [XuiButtonImports, XuiPopoverImports],
  template: `
    <a class="text-link cursor-pointer underline" tabindex="0" [xuiPopover]="card" interactionKind="hover"
      >&#64;rikarin</a
    >
    <ng-template #card>
      <div class="w-64 p-4">
...
@Component({
  ...
  template: `
    ...
    <ng-template #tip
      ><div class="px-3 py-2 text-sm">Placed {{ placement() }}</div></ng-template
    >
  `
})
export class PreviewPlacements {
  protected placement: any;
