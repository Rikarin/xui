  ...
  symbols: [
  {
    ...
    "methods": [
      ...
      },
      {
        ...
        "docs": "Which option holds the single tab stop: the selected one, or — when nothing is selected yet — the first enabled option, so Tab always lands somewhere."
      },
      {
        "name": "writeValue",
