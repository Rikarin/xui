 ...
 * boots, the page has already been painted, and a toggle applied at bootstrap would flash. The
 * shared store reads back what that script decided and takes over from there.
 */
@Injectable({ providedIn: 'root' })
export class Theme {
  private readonly store = createXThemeStore({ storageKey: 'xui-docs-theme' });
