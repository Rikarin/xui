 ...
 */
export interface XDateAdapter<T> {
  /**
   * Create a new date time object.
   */
  create(values: XDateUnits): T;
   ...
   */
  set(date: T, values: XDateUnits): T;

  /**
   * Add a duration to the date time object.
   */
  add(date: T, duration: XDuration): T;

  /**
   * Subtract a duration from the date time object.
   */
  subtract(date: T, duration: XDuration): T;
